...
public class AuthService {
    ...
    /**
     * Couverture du journal d'audit (etape 7.8) : connexions et echecs.
     * acteur vient de la requete, pas du contexte de securite - il n'y a pas
     * encore d'utilisateur authentifie a ce stade, y compris en cas de
     * succes (l'aspect intercepte l'appel avant que le jeton ne soit emis).
     * detail porte le message d'erreur en cas d'echec (#erreur), absent
     * (null) en cas de succes.
     */
    @Audite(action = "CONNEXION", acteur = "#requete.email()", detail = "#erreur")
