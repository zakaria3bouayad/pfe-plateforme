...
public class UtilisateurService {
    ...
    /** Couverture du journal d'audit (etape 7.8) : activation/desactivation de compte. */
    @Audite(action = "COMPTE_STATUT_MODIFIE", cible = "'Utilisateur#' + #id",
            detail = "#actif ? 'Activation du compte' : 'Desactivation du compte'")
    @Transactional
